...
"")
        ...
        self.proc_table = QtWidgets.QTableWidget(self.tab)
        self.proc_table.setObjectName("proc_table")
        self.proc_table.setColumnCount(6)
        self.proc_table.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.proc_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.proc_table.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.proc_table.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.proc_table.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.proc_table.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.proc_table.setHorizontalHeaderItem(5, item)
        self.proc_table.horizontalHeader().setCascadingSectionResizes(False)
        self.proc_table.horizontalHeader().setSortIndicatorShown(False)
        self.proc_table.horizontalHeader().setStretchLastSection(True)
        self.horizontalLayout_4.addWidget(self.proc_table)
        ...
        sizePolicy.setHeightForWidth(self.fs_table.sizePolicy().hasHeightForWidth())
        self.fs_table.setSizePolicy(sizePolicy)
        self.fs_table.setTabletTracking(False)
        self.fs_table.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.fs_table.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustIgnored)
        self.fs_table.setAutoScroll(True)
        self.fs_table.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.fs_table.setSelectionMode(QtWidgets.QAbstractItemView.NoSelection)
        self.fs_table.setTextElideMode(QtCore.Qt.ElideLeft)
        self.fs_table.setShowGrid(True)
        ...
        self.fs_table.horizontalHeader().setVisible(False)
        self.fs_table.horizontalHeader().setCascadingSectionResizes(False)
        self.fs_table.horizontalHeader().setDefaultSectionSize(100)
        self.fs_table.horizontalHeader().setSortIndicatorShown(False)
...
"border: none;")
    ...
    def retranslateUi(self, Form):
        ...
        item = self.proc_table.horizontalHeaderItem(0)
        item.setText(_translate("Form", "1"))
        item = self.proc_table.horizontalHeaderItem(1)
        item.setText(_translate("Form", "2"))
        item = self.proc_table.horizontalHeaderItem(2)
        item.setText(_translate("Form", "3"))
        item = self.proc_table.horizontalHeaderItem(3)
        item.setText(_translate("Form", "4"))
        item = self.proc_table.horizontalHeaderItem(4)
        item.setText(_translate("Form", "5"))
        item = self.proc_table.horizontalHeaderItem(5)
