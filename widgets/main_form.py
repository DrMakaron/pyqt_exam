...
"")
        ...
        self.plot_cpu_widget = QtWidgets.QWidget(self.tab_2)
        self.plot_cpu_widget.setObjectName("plot_cpu_widget")
        self.verticalLayout.addWidget(self.plot_cpu_widget)
        self.plot_ram_widget = QtWidgets.QWidget(self.tab_2)
        self.plot_ram_widget.setObjectName("plot_ram_widget")
        self.verticalLayout.addWidget(self.plot_ram_widget)
